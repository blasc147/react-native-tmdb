...
const topRatedMoviesEndpoint = (page = 1) =>
  `${apiBaseUrl}/movie/top_rated?api_key=${apiKey}&page=${page}`
const topRatedSeriesEndpoint = (page = 1) =>
  `${apiBaseUrl}/tv/top_rated?api_key=${apiKey}&page=${page}`
...
export const useRatedMovies = ({ page = 1 }) => {
  return useQuery({
...
export const useRatedSeries = (page = 1) =>
  useQuery({
    queryKey: ['ratedSeries', page],
